...
const { create, remove, productById, listBySearch, share, getCarts, putPurchaseCart } = require('../controllers/product');
...
router.post('/putpurchasecart/:productId', putPurchaseCart);
